...
<div class="container" style="width: 800px; margin:0 auto">
    ...
    <p>根据《中华人民共和国合同法》及相关法律法规的规定，四方遵循平等自愿的原则，经友好协商，就各方在平台方运营管理的快投机器（域名为www.fengrongwang.com,“快投机器”，以下简称平台）上进行资金借贷、担保等事宜达成一致，以兹信守。</p>
    <br>
    ...
    <br><br><br><br><br>
	<div style="background:url(http://www.fengrongwang.com/style/img/gongzhang.gif) no-repeat; overflow:hidden; background-position:20% 100%">
    <p>甲方（出借人）:<?php echo $info[4]['name'];?></p>
    <p>身份证号：<?php echo $info[4]['idcard'];?></p>
    <p>乙方（借款人）:<?php echo $info[3]['company_name'];?></p>
    <p>注册号：<?php echo $info[3]['license_no'];?></p>
