...
<?php /*?>    <style type="text/css">
    @media print {
		#gongzhang{background:url(http://www.fengrongwang.com/style/img/gongzhang.gif) no-repeat; overflow:hidden; background-position:20% 100%; z-index:999; position:relative; width:300px; height:100px}	
	}
    </style><?php */?>
</head>
...
<div class="container" style="width: 800px; margin:0 auto" id="print">
    ...
    <small>合同编号：KTJQ<?php echo $info[2]['number'];?>-<?php echo $info[0]['id'];?></small>
    ...
    <br><br><br><br><br>
	<div style="background:url(http://test.kuaitoujiqi.com/style/img/gongzhang.gif) no-repeat; overflow:hidden; background-position:20% 100%;height:151px;" >
    <p>甲方（出借人）:<?php echo $info[4]['name'];?></p>
