   ...
   <div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="ad">
		<div class="container" style="height:42px;line-height:26px;">
			<ul class="row" id="contain">
				<?php foreach($webgonggao as $key){?>
				<li style="margin-left:15px;">
					<span><a href="<?php echo site_url('news/article/'.$key['id']);?>" style="color:#337ab7;"><img src="<?php echo base_url();?>style/img/V2_03.gif" alt=""/>[ 快投机器公告 ]</a></span>
					<span style="margin:0px 30px;"><a href="<?php echo site_url('news/article/'.$key['id']);?>"><?php echo $key['title'];?></a></span>
					<span style="margin:0px 50px 0px 200px;"><?php echo substr($key['dateline'],5,5);?></span>
					<span><a href="<?php echo site_url('news/article/'.$key['id']);?>">查看详情</a></span>
					<span><a href="<?php echo site_url('news/newslist/11');?>" style="margin-left:50px;color:#337ab7;text-decoration: underline;">更多公告</a></span>
				</li>
				<?php }?>
				...
				<div class="projectTitle">
					...
					<div class="col-xs-12 col-md-2 text-right an">
						<div style="margin-top:20px;">
							<?php if($key['static'] == 1){
								if($key['restmoney'] == 0){?>
									<a href="<?php echo site_url('product/bulk_standard/'.$key['id']);?>" class="btn btn-primary btn-normal btn-block" target="_blank" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;审核中&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
								<?php }else{
										if($key['is_open'] == 1 and $key['creattime'] > date('Y-m-d H:i:s')){ 
										//预告  当前时间小于开始时间?>
											<a href="<?php echo site_url('product/bulk_standard/'.$key['id']);?>" class="btn btn-success btn-primary btn-normal btn-block" id="ljgm_step3" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;即将上线&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
										<?php }else{?>
											<a class="btn btn-danger btn-normal btn-block" href="<?php echo site_url('product/bulk_standard/'.$key['id']);?>" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;立即投资&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
							<?php } } }?>
							<?php if($key['static'] == 2){?>
								<a class="btn btn-default btn-block" href="<?php echo site_url('product/bulk_standard/'.$key['id']);?>" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;还款中&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
							<?php }?>
							<?php if($key['static'] == 3){?>
   ...
   <!--<div>
	...
	<div style="background-color:#f9fbfc;">
		<div class="platform row text-center" style="width:1150px;margin:0px auto;padding-top:30px;padding-left:0px;">
			<div class="col-xs-6 col-md-5 FLeft">
			...
			<div class="col-xs-6 col-md-5 fRight">
				<div class="col-xs-12 col-md-6" style="padding-left:0px;">
	...
	<div style="background-color:#fff;padding-bottom:30px;">
		<div style="width:1150px;margin:10px auto;padding-top:20px;">
			...
			<div style="margin:20px 0px 30px 50px;">
				...
				<a href="http://2607973.1024sj.com/" target="_blank"><img src="<?php echo base_url();?>style/img/header/V2_17.jpg" /></a>
