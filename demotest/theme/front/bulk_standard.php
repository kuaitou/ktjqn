...
<!--项目详情页-->
 <div style="background: #f2f2fd;padding:20px 0">
        <div class="container mt10" style="background:#fff;">
            <div class="row" style="margin-bottom:10px;border-left:4px solid #337ab7;border-bottom:1px solid #eee;padding:10px 30px;">
				<div>
					<h4 style="float:left;">
						<?php echo $row['title'];?>
					</h4>
					<p style="float:right;color:#ddd;margin-right:20px;margin-top:10px;"><?php echo date('Y年m月d日 H:i',strtotime($row['creattime']));?></p>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-md-8" style="padding-left: 0;padding-right: 0;">
					...
					<div class="row">
						<div class="col-xs-12 col-md-10" style="padding-left:60px;">
							...
							<div style="height:5px;position:relative;top:-5px;">
								<div class="pull-left" style="height:5px;background:#00aac6;width:100%;border-radius:0 4px 4px 0;"></div>
								<div class="clear"></div>
							</div>
						</div>
					</div>
