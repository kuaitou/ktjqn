...
<div>
    ...
    <div class="row flat_video">
        <div class="col-xs-12 col-md-2">
            <a href="<?php echo site_url('news/article/'.$key['id']);?>"><img src="<?php echo base_url();?><?php echo $key['photo'];?>" alt="<?php echo $key['title'];?>"/></a>
        </div>
...
<div>
    <div class="risk_economic">
		<?php foreach($result as $key){?>
        <div class="row p_d">
			<h4><a href="<?php echo site_url('news/article/'.$key['id']);?>" target="_blank"><?php echo $key['title'];?></a><span><?php echo $key['dateline'];?></span></h4>
