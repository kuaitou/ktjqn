...
.list_select  .active{
   ...
   <div class="container mt10" style="border-bottom:1px solid #337ab7;">
		<ul class="row test">
			<li class="list" style="width:134px;"><a href="<?php echo site_url('product/bulk_standard_list');?>" style="color:#337ab7;padding:0px 30px;margin:0px;text-decoration:none;">投资列表</a></li>
			<li class="transfer_list" style="height:40px;padding-top:0px;background-color: #eee;border-radius: 3px;text-decoration:none;" ><a href="<?php echo site_url('product/transfer_list');?>">债券转让列表</a></li>
		</ul>
   </div>
				...
				<div style="margin-top:20px;">
					<?php if($key['static'] == 1){
						...
						<?php }else{
							...
							//预告  当前时间小于开始时间?>
								<a href="<?php echo site_url('product/bulk_standard/'.$key['id']);?>" class="btn btn-block btn-success btn-primary btn-normal" id="ljgm_step3" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;即将上线&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
							<?php }else{?>
...
<div class="row text-center" style="margin:20px auto 50px auto;">
	<nav>
		<ul class="pagination">
			<?php echo $links;?>
		</ul>
